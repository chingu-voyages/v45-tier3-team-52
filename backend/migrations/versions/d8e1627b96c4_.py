...
Revision ID: d8e1627b96c4
Revises: 
Create Date: 2023-09-17 14:49:32.814547
...
if environment == "production":
        ...
        op.execute(f"ALTER TABLE user_portfolios SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE portfolio_assets SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE transactions SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE asset_transactions SET SCHEMA {SCHEMA};")
